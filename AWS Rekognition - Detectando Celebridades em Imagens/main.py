...
def compare_faces(
    source_image_path: str, target_image_path: str, similarity_threshold: int = 90
):
...
def draw_boxes(
    ...
    for face in face_details:
        ...
        draw.text((left, top - 10), f"{similarity:.1f}%", fill="red",font=font)
...
if __name__ == "__main__":
    source_image_path = get_path("cr7.jpg")
    target_image_path = get_path("bbc.jpg")
    output_image_path = get_path("resultado_bbc.jpg")
