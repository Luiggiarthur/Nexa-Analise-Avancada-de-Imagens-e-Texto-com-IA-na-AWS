...
def detect_file_text() -> None: #função que detecta o texto na imagem através do textract e retorna em formato JSON
...
def get_lines() -> list[str]: #função que busca o texto no arquivo JSON
    try:
